...
import tv.z85.esi.models.GetIncursions200Ok
...
class IncursionsApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    * @return kotlin.Array<GetIncursions200Ok>
    ...
    */
    ...
    fun getIncursions(datasource: kotlin.String?, ifMinusNoneMinusMatch: kotlin.String?) : kotlin.Array<GetIncursions200Ok> {
        ...
        val localVarResponse = request<kotlin.Array<GetIncursions200Ok>>(
            localVariableConfig,
            localVariableBody
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as kotlin.Array<GetIncursions200Ok>
