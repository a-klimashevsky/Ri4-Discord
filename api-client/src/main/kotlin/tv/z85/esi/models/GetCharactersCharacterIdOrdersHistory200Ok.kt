...
data class GetCharactersCharacterIdOrdersHistory200Ok (
    ...
    @Json(name = "range")
    var range: GetCharactersCharacterIdOrdersHistory200Ok.Range,
    /* ID of the region where order was placed */
    @Json(name = "region_id")
    var regionId: kotlin.Int,
    /* Current order state */
    @Json(name = "state")
    var state: GetCharactersCharacterIdOrdersHistory200Ok.State,
