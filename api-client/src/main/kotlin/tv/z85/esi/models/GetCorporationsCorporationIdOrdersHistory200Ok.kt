...
/**
 * 200 ok object
 * @param duration Number of days the order was valid for (starting from the issued date). An order expires at time issued + duration
 ...
 * @param issuedBy The character who issued this order
 ...
 * @param walletDivision The corporation wallet division used for this order
 */

data class GetCorporationsCorporationIdOrdersHistory200Ok (
    ...
    @Json(name = "range")
    var range: GetCorporationsCorporationIdOrdersHistory200Ok.Range,
    /* ID of the region where order was placed */
    @Json(name = "region_id")
    var regionId: kotlin.Int,
    /* Current order state */
    @Json(name = "state")
    var state: GetCorporationsCorporationIdOrdersHistory200Ok.State,
    ...
    @Json(name = "wallet_division")
    var walletDivision: kotlin.Int
) {
