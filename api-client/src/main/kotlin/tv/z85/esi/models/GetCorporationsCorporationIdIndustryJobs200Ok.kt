 ...
 * @param locationId ID of the location for the industry facility
...
data class GetCorporationsCorporationIdIndustryJobs200Ok (
    /* Job activity ID */
    ...
    /* status string */
    @Json(name = "status")
    var status: GetCorporationsCorporationIdIndustryJobs200Ok.Status,
