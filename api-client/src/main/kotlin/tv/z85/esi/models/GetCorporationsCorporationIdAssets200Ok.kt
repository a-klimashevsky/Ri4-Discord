...
data class GetCorporationsCorporationIdAssets200Ok (
    ...
    var locationFlag: GetCorporationsCorporationIdAssets200Ok.LocationFlag,
    /* location_id integer */
    @Json(name = "location_id")
    var locationId: kotlin.Long,
    /* location_type string */
    @Json(name = "location_type")
    var locationType: GetCorporationsCorporationIdAssets200Ok.LocationType,
    /* quantity integer */
    @Json(name = "quantity")
    ...
    */
    ...
    enum class LocationFlag(val value: kotlin.String){
        ...
        @Json(name = "QuantumCoreRoom") quantumCoreRoom("QuantumCoreRoom"),
