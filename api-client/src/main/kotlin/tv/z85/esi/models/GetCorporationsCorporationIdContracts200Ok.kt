...
data class GetCorporationsCorporationIdContracts200Ok (
    ...
    var availability: GetCorporationsCorporationIdContracts200Ok.Availability,
    ...
    @Json(name = "status")
    var status: GetCorporationsCorporationIdContracts200Ok.Status,
    /* Title of the contract */
    @Json(name = "title")
    var title: kotlin.String? = null,
    /* Type of the contract */
    @Json(name = "type")
    var type: GetCorporationsCorporationIdContracts200Ok.Type,
