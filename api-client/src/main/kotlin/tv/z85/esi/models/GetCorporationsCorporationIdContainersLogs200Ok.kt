 ...
 * @param characterId ID of the character who performed the action.
 * @param containerId ID of the container
 * @param containerTypeId Type ID of the container
 * @param locationFlag location_flag string
 * @param locationId location_id integer
 * @param loggedAt Timestamp when this log was created
 * @param newConfigBitmask new_config_bitmask integer
 * @param oldConfigBitmask old_config_bitmask integer
 * @param passwordType Type of password set if action is of type SetPassword or EnterPassword
 * @param quantity Quantity of the item being acted upon
 * @param typeId Type ID of the item being acted upon
 */

data class GetCorporationsCorporationIdContainersLogs200Ok (
    /* action string */
    @Json(name = "action")
    var action: GetCorporationsCorporationIdContainersLogs200Ok.Action,
    /* ID of the character who performed the action. */
    @Json(name = "character_id")
    var characterId: kotlin.Int,
    /* ID of the container */
    @Json(name = "container_id")
    var containerId: kotlin.Long,
    /* Type ID of the container */
    @Json(name = "container_type_id")
    var containerTypeId: kotlin.Int,
    /* location_flag string */
    @Json(name = "location_flag")
    var locationFlag: GetCorporationsCorporationIdContainersLogs200Ok.LocationFlag,
    /* location_id integer */
    @Json(name = "location_id")
    var locationId: kotlin.Long,
    /* Timestamp when this log was created */
    @Json(name = "logged_at")
    var loggedAt: java.time.OffsetDateTime,
    /* new_config_bitmask integer */
    @Json(name = "new_config_bitmask")
    var newConfigBitmask: kotlin.Int? = null,
    /* old_config_bitmask integer */
    @Json(name = "old_config_bitmask")
    var oldConfigBitmask: kotlin.Int? = null,
    /* Type of password set if action is of type SetPassword or EnterPassword */
    @Json(name = "password_type")
    var passwordType: GetCorporationsCorporationIdContainersLogs200Ok.PasswordType? = null,
    ...
    /**
    * action string
    * Values: add,assemble,configure,enterPassword,lock,move,repackage,setName,setPassword,unlock
    */
    
    enum class Action(val value: kotlin.String){
        @Json(name = "add") add("add"),
        @Json(name = "assemble") assemble("assemble"),
        @Json(name = "configure") configure("configure"),
        @Json(name = "enter_password") enterPassword("enter_password"),
        @Json(name = "lock") lock("lock"),
        @Json(name = "move") move("move"),
        @Json(name = "repackage") repackage("repackage"),
        @Json(name = "set_name") setName("set_name"),
        @Json(name = "set_password") setPassword("set_password"),
    ...
    */
    ...
    enum class PasswordType(val value: kotlin.String){
